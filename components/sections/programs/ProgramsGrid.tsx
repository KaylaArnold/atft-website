      ...
      <section className="bg-brand-white" style={{ paddingTop: "4rem", paddingBottom: "3rem" }}>
        <div className="max-w-site mx-auto px-6">
          ...
          <div className="flex flex-col items-center gap-4 mb-12 text-center">
            ...
            <p className="text-base text-brand-brown max-w-xl leading-relaxed">All programs are built on the 5% DRIP Method framework — structure, discipline, and capital protection first.</p>
          </div>
