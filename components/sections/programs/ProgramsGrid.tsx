...
const PROGRAM_SECTIONS: ProgramSection[] = [
  ...
  },
  {
    ...
    eyebrow: "Work Directly with Coach Arletta",
    description: "Go deeper with private, high-touch experiences designed for serious traders and leaders.",
    programs: [
      {
        name: "The J20 Trading Foundation",
        description: "Direct instruction with the founder of ATFT. Learn the complete ATFT Options Trading System directly from Coach Arletta, including options trading fundamentals, the J20 Strategy, risk management, trade execution, and more.",
        details: "This class is for traders who want to learn the trading system directly from Coach Arletta",
        highlight: "Appointment required",
        price: 1250,
        bookingUrl: "https://forms.gle/Sd7nEo5uAWfVbCPT6",
        buttonLabel: "Apply for This Session",
      },
      {
        name: "Dual Strategy Experience",
        description: "The client chooses ONE advanced path to pair with the foundation. OPTION A is Trading Foundations + Swing and OPTION B is Trading Foundations + Futures.", 
        details: "This class is for traders who want to go further than just learning the fundamentals of trading.",
        highlight: "Application and appointment required",
        price: 2499,
        bookingUrl: "https://forms.gle/Sd7nEo5uAWfVbCPT6",
        buttonLabel: "Apply for This Session",
      ...
      {
        name: "Complete Trading Experience",
        description: "The complete private trading experience. This comprehensive program covers trading foundations, J20, compounding, swing trading, futures, and 30 days of peer coaching.",
        details: "30 days of peer coaching and support included.",
        highlight: "Application and appointment required",
        price: 4999,
        bookingUrl: "https://forms.gle/Sd7nEo5uAWfVbCPT6",
  ...
  },
  {
    ...
    programs: [
      {
        name: "30-Day Peer Coaching",
        badge: "Short-Term Support",
        badgeColor: "#1a6b3c",
        badgeBg: "#e6f4ed",
        description: "A focused 30-day coaching experience for traders who need a reset, additional accountability, or help getting back on track.",
        details: "Includes 4 weekly one-on-one sessions",
        highlight: "Ideal for short-term accountability and focus",
        price: 499,
        bookingUrl: "https://buy.stripe.com/9B67sL9gf7Fzg9k9rYb3q0o",
        buttonLabel: "Purchase This Program",
      },
      {
        name: "90-Day Peer Coaching",
        badge: "Extended Support",
        badgeColor: "#7a4f00",
        badgeBg: "#fef3e2",
        description: "A 90-day coaching experience designed to help you establish stronger habits, improve consistency, and work through recurring trading patterns.",
        details: "Includes 12 weekly one-on-one sessions",
        highlight: "Build stronger discipline and consistency",
        price: 1299,
        bookingUrl: "https://buy.stripe.com/5kQ00j0JJ6Bv5uG6fMb3q0p",
        buttonLabel: "Purchase This Program",
      },
      {
        name: "6-Month Peer Coaching",
        badge: "Comprehensive Support",
        badgeColor: "#8B1a1a",
        badgeBg: "#fde8e8",
        description: "Long-term personalized coaching for traders who want consistent accountability and support while developing sustainable trading habits.",
        details: "Includes weekly one-on-one sessions for 6 months",
        highlight: "Our most comprehensive accountability option",
        price: 2399,
        bookingUrl: "https://buy.stripe.com/dRmdR93VVaRL3myfQmb3q0q",
        buttonLabel: "Purchase This Program",
      },
    ],
  },
