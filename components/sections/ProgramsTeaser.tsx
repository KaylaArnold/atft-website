      ...
      <div className="max-w-site mx-auto px-6">
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6 mb-16">
          <div className="flex flex-col gap-4">
            ...
            <h2 className="font-display text-4xl lg:text-5xl font-bold text-brand-black leading-tight">
              Find your program. Start your drip.
            </h2>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          {FEATURED_PROGRAMS.map((program) => (
            <div key={program.name} className="flex flex-col gap-4 rounded-2xl p-6 bg-brand-white hover:-translate-y-1 transition-all duration-300" style={{ border: "1px solid rgba(201,168,76,0.15)" }}>
