      ...
      <div className="max-w-site mx-auto px-6">
        ...
        <div className="flex flex-col items-center gap-4 mt-8 mb-8 p-6 rounded-2x1" style={{ background: "#FBF6EC", border: "1px solid rgba(201,168,76,0.15)" }}>
          ...
          <div className="flex flex-wrap items-center justify-center gap-3">
            ...
            <a href="https://twitter.com/intent/tweet?text=Join%20me%20in%20celebrating%20Founders%20Day%20with%20Coach%20Arletta!%20Show%20your%20support%20here%3A&url=https%3A%2F%2Fwww.arlettathefriendlytrader.com%2Ffoounders-day"
            ...
            <a href="https://www.youtube.com/share?url=https://youtube.com/live/U47pq5-NFpU" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-4 py-2 rounded-full text-xs font-semibold transition-all duration-200 hover:opacity-80" style={{ background: "#FF0000", color: "#fff" }}>
