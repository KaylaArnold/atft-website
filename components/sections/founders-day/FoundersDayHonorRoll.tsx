  ...
  return (
    <section className="section-padding bg-brand-white">
      <div className="max-w-site mx-auto px-6">
        ...
        <div className="flex flex-col items-center gap-6 text-center mb-16 max-w-3xl mx-auto">
          ...
          <div className="p-8 rounded-2xl text-left" style={{ background: "#FBF6EC", border: "1px solid rgba(201,168,76,0.2)" }}>
            <p className="text-base text-brand-brown leading-relaxed mb-4">
              One year ago, I answered God's call to teach people how to trade and build wealth through discipline, wisdom, and faith. I had no idea that one "yes" would become a movement that would impact thousands of lives.
            </p>
            <p className="text-base text-brand-brown leading-relaxed mb-4">
              Founders Day was not simply a celebration of a business milestone — it was a celebration of every life changed, every breakthrough experienced, every fear overcome, and every dream that began to feel possible.
            </p>
            <p className="text-base text-brand-brown leading-relaxed mb-4">
              To every person who gave a financial gift, sent flowers, presented a thoughtful gift, served behind the scenes, prayed, encouraged me, or simply showed up to celebrate this moment — thank you. Your generosity wasn't just a gift to me. It was an investment in a mission committed to changing lives for generations to come.
            </p>
            <p className="text-base text-brand-brown leading-relaxed mb-4">
              I am deeply honored, incredibly humbled, and forever grateful to each of you. May God return your generosity to you, pressed down, shaken together, and running over.
            </p>
        ...
        {/* Honor Roll */}
        <div className="mb-16">
          <h3 className="font-display text-3xl font-bold text-brand-black text-center mb-10">Honor Roll</h3>
          <div className="flex flex-col gap-10">
            {HONOR_ROLL.map((section) => (
        ...
        <div className="mb-16">
          ...
          <p className="text-base text-brand-brown text-center max-w-2xl mx-auto mb-8">
            These individuals gave something that cannot be measured in dollars. Their service, dedication, encouragement, and willingness to help made Founders Day possible.
          </p>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <div className="text-center max-w-2xl mx-auto p-10 rounded-2xl" style={{ background: "#0F0A02", border: "1px solid rgba(201,168,76,0.2)" }}>
          <p className="text-base leading-relaxed mb-4" style={{ color: "rgba(249,246,240,0.7)" }}>
            Every contribution, every prayer, every encouraging word, every gift, and every act of kindness has become part of the story God is writing through this community.
          </p>
          <p className="text-base leading-relaxed mb-4" style={{ color: "rgba(249,246,240,0.7)" }}>
            Thank you for believing in the vision. Thank you for believing in the mission. Thank you for believing in us. May God continue to bless you abundantly.
          </p>
          <p className="font-display text-xl font-bold mt-6" style={{ color: "#E8C96A" }}>
