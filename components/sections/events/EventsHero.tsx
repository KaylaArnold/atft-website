      ...
      <div className="relative max-w-site mx-auto px-6">
        <div className="flex flex-col items-center text-center gap-6 max-w-3xl mx-auto">
          <div className="flex items-center gap-3">
            ...
            <span className="text-xs font-semibold tracking-widest uppercase text-gold">Community Events</span>
            <div className="h-px w-8" style={{ background: "#C9A84C" }} />
          </div>
          ...
          <p className="text-lg leading-relaxed max-w-2xl" style={{ color: "rgba(249,246,240,0.7)" }}>
            Community gatherings, live sessions, celebrations, and more. Come as you are — every event is an opportunity to grow, connect, and be inspired.
          </p>
          <div className="p-4 rounded-xl mt-2" style={{ background: "rgba(201,168,76,0.08)", border: "1px solid rgba(201,168,76,0.2)" }}>
            <p className="text-sm" style={{ color: "rgba(249,246,240,0.7)" }}>
              Looking for trading classes? Visit our <a href="/programs" className="text-gold hover:underline">Programs page</a> to browse and book all available classes.
            </p>
          </div>
        </div>
      </div>
