  ...
  return (
    <section id="tiers" className="section-padding bg-brand-white">
      <div className="max-w-site mx-auto px-6">
        ...
        <div className="text-center mt-4 mb-8 flex flex-col items-center gap-2">
        ...
        <div className="flex flex-col items-center gap-4 mt-8 mb-8 p-6 rounded-2xl" style={{ background: "#FBF6EC", border: "1px solid rgba(201,168,76,0.15)" }}>
          ...
          <div className="flex flex-wrap items-center justify-center gap-3">
            ...
            <a href="https://www.youtube.com/watch?v=JwU2FOwxrJc" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-4 py-2 rounded-full text-xs font-semibold transition-all duration-200 hover:opacity-80" style={{ background: "#FF0000", color: "#fff" }}>
