          ...
          <div className="flex justify-center lg:justify-end">
            ...
            >
              ...
              {/* CTA */}
                ...
                className="inline-flex items-center justify-center px-8 py-4 rounded-md text-sm font-semibold text-brand-black hover:opacity-90 transition-all duration-200 text-center"
...
with open("components/sections/CommunitySection.tsx", "w", encoding="utf-8") as f:
    f.write(content)
